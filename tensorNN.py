# -*- coding: utf-8 -*-
"""
Created on Sun Jun 18 21:27:54 2017
  ...
  for i in range(5000):
    ...
    if i % 100 == 0:
      train_accuracy = accuracy.eval(feed_dict={
          x: batch[0], ycorr: batch[1]})
      print('step %d, training accuracy %g' % (i, train_accuracy))
    train_step.run(feed_dict={x: batch[0], ycorr: batch[1]})

    print('test accuracy %g' % accuracy.eval(feed_dict={x: mnist.test.images, ycorr: mnist.test.labels}))
